...
import { mockLabResults } from './mock';
import { labsResultsColumns } from '@/components/columns-bucket';

const LabsResults = () => {
  const columns = labsResultsColumns;
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">Labs & Results</h1>
            ...
            <Table className="w-full sm:min-w-[800px]">
              ...
              <TableBody>
                {table.getRowModel().rows?.length ? (
                  ...
                  <TableRow>
                    <TableCell colSpan={labsResultsColumns.length} className="h-24 text-center">
